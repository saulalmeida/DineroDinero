...
/**
 * Created by Elite desk 700g1 on 19/01/2018.
 */
...
class SwippeControl extends ItemTouchHelper.Callback {
    ...
    public SwippeControl(SwipeControllerActions buttonsActions) {
        ...
        recyclerView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
                    SwippeControl.super.onChildDraw(c, recyclerView, viewHolder, 0F, dY, actionState, isCurrentlyActive);
                    recyclerView.setOnTouchListener(new View.OnTouchListener() {
                        @Override
                        public boolean onTouch(View view, MotionEvent motionEvent) {
                            return false;
